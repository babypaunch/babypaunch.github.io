...
for (const [relative, required] of [
  ...
  ['policies/echo-note/privacy/index.html', ['하이브리드 영단어 학습 앱', 'Google Play Integrity 토큰', 'study365.site', '광고 식별자', 'User Messaging Platform', '오프라인 영어 Text-to-Speech', 'babypaunch@gmail.com']],
  ['en/policies/echo-note/privacy/index.html', ['hybrid English vocabulary learning app', 'Google Play Integrity token', 'study365.site', 'advertising ID', 'User Messaging Platform', 'offline English Text-to-Speech', 'babypaunch@gmail.com']],
]) {
  const html = fs.readFileSync(path.join(siteRoot, relative), 'utf8');
